...
async function FetchDashboardData() {
  ...
  return (
   <main className="md:ml-64 min-h-screen pt-24 md:pt-12 px-6 md:px-12 pb-12">
...
<img className="w-10 h-10 rounded-full border-2 border-background object-cover" data-alt="Portrait of a young woman with a warm smile and professional attire" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDGQr-TVPtCfwoxhUg0VpWuKjBqNBR-3lpk3PFskJqudO2N4_qBYx_1aDRI2qow4wiiliRAit6lBN5V7le2-k-iYJRQyRvHaE3ApgDnfyGWR47rC3SFjYgEfcIgBF3vmptQ2hiYM533k5IwF_5JMGZXcd2SKACc51xvkiqbXotrmtUwwf-tB_1dGudl2Ym-yu8zEkqiLmQkEaaQtIEoh7jKJfLiAjNjEQuwuO1cc02eR-Ks-6SaghEWr19VFxeKpItqnYi5XKS5R_c"  />
<img className="w-10 h-10 rounded-full border-2 border-background object-cover" data-alt="Smiling man with glasses in a casual studio setting" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBGDRDZEzOzElXJHz74If0IxdbEW-A7U1553XFknhgkwh2aoSBcUe5ya4bGnPYe5S3ocMYy53PJqH0mUw8_EeUJsi6U9Qk4j0FbHphV3sc6hmRUkYqtBKAtEtVjUBSV9EBPXU4KOBe7vsaU28LarkxsN3IkqA0LTgtMpwCHXWFrZkGuri3n7zcrKe-lr3zPBnBfvnMHg9pYsySuxmyrO57RtReluCfwG_qOLxHbtaT4jXVyIuTeQl9cJcCNnhWNl-HvdaqmI1L22yw"  />
<div className="w-10 h-10 rounded-full border-2 border-background bg-surface-container-highest flex items-center justify-center text-xs font-bold text-on-surface"  >+4</div>
</div>
<span className="text-on-surface-variant text-sm"  >Active Members</span>
</div>
</div>
</section>
...
<span className="material-symbols-outlined text-6xl text-on-surface" data-icon="trending_down"  >trending_down</span>
</div>
...
<div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
<span className="material-symbols-outlined text-6xl text-on-surface" data-icon="schedule"  >schedule</span>
</div>
<div className="relative z-10">
