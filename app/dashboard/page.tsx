...
async function DashboardContent() {
 ...
 return (
  ...
  <div className="max-w-7xl mx-auto space-y-6">
    ...
    {/* ── Financial Snapshot ───────────────────────────────── */}
    <div className="mb-2">
      <h2 className="text-[11px] font-bold tracking-[0.15em] text-gray-400 uppercase mb-3">
        Financial Snapshot
      </h2>
    </div>

    {/* Fixed: grid-cols-1 on small mobile, grid-cols-2 on sm, grid-cols-4 on lg */}
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6 sm:mb-8">
      
      {/* Liquidity */}
      <div className="bg-white rounded-2xl p-4 sm:p-6 border border-gray-100/80 shadow-sm hover:shadow-md transition-shadow min-w-0">
        ...
        <p className="text-xl sm:text-2xl font-bold text-[#2d3436] truncate">Rs {total.toLocaleString()}</p>
        <div className="flex flex-wrap gap-x-2 sm:gap-x-3 gap-y-1 mt-2 text-xs text-gray-400">
      ...
      <div className="bg-white rounded-2xl p-4 sm:p-6 border border-gray-100/80 shadow-sm hover:shadow-md transition-shadow min-w-0">
        ...
        <p className="text-xl sm:text-2xl font-bold text-[#e17055] truncate">-Rs {monthlyExpenses.toLocaleString()}</p>
      ...
      <div className="bg-white rounded-2xl p-4 sm:p-6 border border-gray-100/80 shadow-sm hover:shadow-md transition-shadow min-w-0">
        ...
        <p className={`text-xl sm:text-2xl font-bold truncate ${netDebt >= 0 ? "text-[#00b894]" : "text-[#e17055]"}`}>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6 sm:mb-8">
      ...
      {/* Savings Vault */}
      <div className="bg-[#2d3436] rounded-2xl p-5 sm:p-6 text-white relative overflow-hidden shadow-sm sm:col-span-2 lg:col-span-1">
        ...
        <p className="text-2xl sm:text-3xl font-bold truncate">Rs {savingsBalance.toLocaleString()}</p>
